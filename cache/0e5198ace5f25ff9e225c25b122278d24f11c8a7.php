<?php $__env->startSection('content'); ?><p>A tricky number-based brainteaser has left players scratching their heads with even the most eagle-eyed puzzlers stumped.</p>

<p>The vexing new challenge has been created by UK-based marketing company Reflect Digital to mark the start of National Coding Week, an annual event that aims to encourage more people to learn to code. </p>
...
<p>Another puzzle, created by UK-based company Swift Direct Blinds, challenges the nation to find the bumblebee buzzing among the flowers.</p>

<p>The colourful graphic shows blooms of all colours and shapes, with just a single insect hidden somewhere in the scene.</p>

<p>Creators have revealed that the current record stands at an impressive 63 seconds - so, how long will it take you?</p>

<p>Scroll down for reveal </p>

<p>A new brainteaser (pictured), created by UK-based Swift Direct Blinds, is challenging puzzlers to find the hidden bee amongst the flowers</p>

<p>The colourful graphic is probably the closest hayfever sufferers will get to a bunch of flowers, but can you prove yourself to be king or queen bee and find the disguised insect in the quickest time?</p>

<p>If this is the most complicated display of flowers you've ever seen, here's a handy clue. The buzzing bee is sat at the edge of a yellow petal.</p>

<p>Still looking? Before you get to the top left corner – you'll pass this busy bee along the way. </p>

<p>If you're struggling to find the answer, then feast your eyes towards the top left-hand side of the graphic, where you'll find the answer circled in green (pictured)</p>
