			...
			<ul class="text-grey lg:text-dark list-reset leading-loose mt-2">
				...
				<li
					class="
						...
						<?php echo e($page->isActive(strtolower($category)) ? 'active text-blue-600' : ''); ?>

					"
					style="opacity: 1; transform: translateY(0px);"
				>
					<a href="/categories/<?php echo e(strtolower($category)); ?>">
...
<?php /**PATH /home/runner/work/finescoop.github.io/finescoop.github.io/source/_layouts/partials/sidebar.blade.php ENDPATH**/ ?>