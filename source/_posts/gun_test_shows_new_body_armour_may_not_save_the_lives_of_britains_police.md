...
Impact Clay damaged when protected from 762mm bullets, above, by the armour The Ministry of Defence and the Home Office have declared the armour safe
...
The first test replicated the process used by the Government when a plate is mounted in front of a clay mould and a 762mm round fired into it from a set distance The depth of the indentation the impact made in the clay through the armour was 24mm – less than the 25mm maximum required by the Home Office and the 44mm MoD limit, also used by other countries
