...
title: Epic Games tells users Apple is giving an indefinite extension to sing in with Apple IDs 
description: Epic games warned users Apple was set to block accounts using Sign In With Apple. The game maker then said the tech giant is giving an extension - but Apple says there was not a restriction in place. 
